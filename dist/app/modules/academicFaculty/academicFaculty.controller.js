...
const academicFaculty_constrains_1 = require("./academicFaculty.constrains");
...
const getAllFaculties = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(req.query, academicFaculty_constrains_1.academicFacultyFilterableFields);
