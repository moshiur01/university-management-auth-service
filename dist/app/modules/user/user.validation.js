...
const faculty_constrain_1 = require("../faculty/faculty.constrain");
...
const createStudentZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        student: zod_1.z.object({
            ...
            gender: zod_1.z.enum([...student_constant_1.studentConstant.gender], {
            ...
            bloodGroup: zod_1.z
                .enum([...student_constant_1.studentConstant.bloodGroup])
                .optional(),
...
const createFacultyZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        faculty: zod_1.z.object({
            ...
            gender: zod_1.z.enum([...user_constant_1.userConstant.gender], {
                required_error: 'Gender is required',
            }),
            bloodGroup: zod_1.z
            ...
            designation: zod_1.z.enum([...faculty_constrain_1.facultyConstant.designation]),
            academicDepartment: zod_1.z.string({
                required_error: 'Academic department is required',
            }),
            academicFaculty: zod_1.z.string({
