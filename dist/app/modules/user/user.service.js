...
const createStudent = (student, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        //generate student Id
        const id = yield (0, user_utlis_1.generateStudentId)(academicSemester);
...
const createFaculty = (faculty, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        //assign the id to user and faculty object
        user.id = id;
        faculty.id = id;
        // create new faculty using session and it return array
...
const createAdmin = (admin, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        session.startTransaction();
        const id = yield (0, user_utlis_1.generateAdminId)();
        user.id = id;
        admin.id = id;
